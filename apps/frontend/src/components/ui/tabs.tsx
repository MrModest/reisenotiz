  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn(
        ...
        variant === 'contained' && 'border border-border rounded-md overflow-hidden gap-0',
        className,
      )}
      {...props}
    />
